...
| `ST/modelling/pipeline/train`         | FN           |        Alin          |    X     | |
| `ST/modelling/pipeline/save`          | FN           |        Matei         |    X     | |
| `ST/page/deployment`                  | FN           |        Matei         |    X     | |
| `ST/deployment/load`                  | FN           |        Matei         |    X     | |
| `ST/deployment/predict`               | FN           |        Matei         |    X     | |
